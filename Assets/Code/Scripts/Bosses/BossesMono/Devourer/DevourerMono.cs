...
{
    public class DevourerMono : BossBaseMono, IDestructable
    {
        ...
        public void Initialize(string bossName, int attackDelay, int ballCount, float health,
            GameObject areaPrefab, GameObject fencePrefab, float bulletSpeed, int bulletDamage,float speed)
        {
            _bossName = bossName;
            _health = health;
        ...
        internal void Initialize(string name, int attackDelay, int ballCount, float health, GameObject areaPrefab, GameObject fencePrefab, int bulletSpeed, float speed)
        {
