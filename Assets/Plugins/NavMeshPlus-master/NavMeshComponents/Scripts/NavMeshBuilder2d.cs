...
namespace NavMeshPlus.Extensions
{
    ...
    class NavMeshBuilder2d
    {
        ...
        public static void CollectSources(List<NavMeshBuildSource> sources, SpriteRenderer spriteRenderer, int area, NavMeshBuilder2dState builder)
        {
            ...
            src.area = area;
            src.transform = Matrix4x4.TRS(Vector3.Scale(spriteRenderer.transform.position, builder.overrideVector), spriteRenderer.transform.rotation, new Vector3(spriteRenderer.size.x/23f,spriteRenderer.size.y/23f,1));
